...
local volume_bar = require("nod.widgets.volume_arc")
...
local brightness_bar = require("nod.widgets.brightness_arc")
local brightness = format_progress_bar(brightness_bar, "<span foreground='" ..
    beautiful.xcolor5 ..
    "'><b></b></span>")

-- local brightness = require("nod.widgets.brightness_arc")

--- }}}

--- {{{ Ram Widget

-- local ram = require("nod.widgets.ram_arc")

local ram_bar = require("nod.widgets.ram_arc")
...
local disk_bar = require("nod.widgets.disk_arc")
...
local temp_bar = require("nod.widgets.temp_arc")
...
-- local cpu = require("nod.widgets.cpu_arc")

local cpu_bar = require("nod.widgets.cpu_arc")
...
local spot = require("nod.widgets.spot")
local spot_box = create_boxed_widget(spot, 400, 125, beautiful.xcolor0)

-- {{{ Info Widget

local info = require("nod.widgets.info")
...
local weather = require("nod.widgets.weather")
...
local app_launcher = wibox.widget {
    create_launcher("kitty", "", beautiful.xcolor8),
