...
exports.generateTestCurrentFunction = exports.generateTestCurrentFile = exports.generateTestCurrentPackage = exports.toggleTestFile = void 0;
...
function generateTests(conf, goConfig) {
    return new Promise((resolve, reject) => {
        ...
        cp.execFile(cmd, args, { env: goEnv_1.toolExecutionEnvironment() }, (err, stdout, stderr) => {
