...
exports.installCurrentPackage = void 0;
...
function installCurrentPackage() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!goRuntimePath) {
            vscode.window.showErrorMessage(`Failed to run "go install" to install the package as the "go" binary cannot be found in either GOROOT(${goPath_1.getCurrentGoRoot()}) or PATH(${goPath_1.envPath})`);
            return;
        }
