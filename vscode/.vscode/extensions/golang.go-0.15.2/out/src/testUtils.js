...
exports.cancelRunningTests = exports.showTestOutput = exports.goTest = exports.getBenchmarkFunctions = exports.findAllTestSuiteRuns = exports.getTestFunctionDebugArgs = exports.extractInstanceTestName = exports.getTestFunctions = exports.getTestTags = exports.getTestFlags = exports.getTestEnvVars = void 0;
/*---------------------------------------------------------
...
function getTestEnvVars(config) {
    const envVars = goEnv_1.toolExecutionEnvironment();
...
function getTestFunctions(doc, token) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const symbols = yield documentSymbolProvider.provideDocumentSymbols(doc, token);
        ...
        const testify = children.some((sym) => sym.kind === vscode.SymbolKind.Namespace && sym.name === '"github.com/stretchr/testify/suite"');
        return children.filter((sym) => sym.kind === vscode.SymbolKind.Function &&
...
function goTest(testconfig) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const testResult = yield new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!goRuntimePath) {
                vscode.window.showErrorMessage(`Failed to run "go test" as the "go" binary cannot be found in either GOROOT(${goPath_1.getCurrentGoRoot()}) or PATH(${goPath_1.envPath})`);
