...
exports.GoImplementationProvider = void 0;
...
class GoImplementationProvider {
    provideImplementation(document, position, token) {
        ...
        if (!goRuntimePath) {
            vscode.window.showErrorMessage(`Failed to run "go list" to get the scope to find implementations as the "go" binary cannot be found in either GOROOT(${goPath_1.getCurrentGoRoot()}) or PATH(${goPath_1.envPath})`);
            return;
        }
