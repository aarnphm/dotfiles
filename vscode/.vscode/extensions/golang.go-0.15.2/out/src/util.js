...
exports.isPositionInComment = exports.runGodoc = exports.cleanupTempDir = exports.getTempFilePath = exports.rmdirRecursive = exports.makeMemoizedByteOffsetConverter = exports.killProcess = exports.killTree = exports.getWorkspaceFolderPath = exports.handleDiagnosticErrors = exports.runTool = exports.guessPackageNameFromFile = exports.getImportPath = exports.resolvePath = exports.timeout = exports.LineBuffer = exports.getExtensionCommands = exports.getModuleCache = exports.getCurrentGoPath = exports.substituteEnv = exports.getFileArchive = exports.getBinPath = exports.getToolsGopath = exports.isPositionInString = exports.isGoPathSet = exports.isVendorSupported = exports.getGoVersion = exports.getUserNameHash = exports.getStringHash = exports.canonicalizeGOPATHPrefix = exports.getParametersAndReturnType = exports.parseFilePrelude = exports.byteOffsetAt = exports.getGoConfig = exports.GoVersion = exports.goBuiltinTypes = exports.goKeywords = void 0;
...
function getGoVersion() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const warn = (msg) => {
            goStatus_1.outputChannel.appendLine(msg);
            console.warn(msg);
        };
        if (!goRuntimePath) {
...
function getExtensionCommands() {
    const pkgJSON = vscode.extensions.getExtension(const_1.extensionId).packageJSON;
    if (!pkgJSON.contributes || !pkgJSON.contributes.commands) {
        return;
    }
    const extensionCommands = vscode.extensions
        .getExtension(const_1.extensionId)
