...
exports.deactivate = exports.activate = exports.restartLanguageServer = exports.vetDiagnosticCollection = exports.lintDiagnosticCollection = exports.buildDiagnosticCollection = void 0;
...
exports.restartLanguageServer = () => { return; };
function activate(ctx) {
    stateUtils_1.setGlobalState(ctx.globalState);
    stateUtils_1.setWorkspaceState(ctx.workspaceState);
    const configGOROOT = util_1.getGoConfig()['goroot'];
    if (!!configGOROOT) {
        goPath_1.setCurrentGoRoot(configGOROOT);
    }
    goInstallTools_1.updateGoVarsFromConfig().then(() => __awaiter(this, void 0, void 0, function* () {
        ...
        const currentGoroot = goPath_1.getCurrentGoRoot().toLowerCase();
        if (prevGoroot && prevGoroot.toLowerCase() !== currentGoroot) {
            ...
            if (currentVersion) {
                ...
                if (prevVersion !== currVersionString) {
                    if (prevVersion) {
                        vscode.window
                            .showInformationMessage('Your Go version is different than before, a few Go tools may need re-compiling', updateToolsCmdText)
                            .then((selected) => {
                            if (selected === updateToolsCmdText) {
                                goInstallTools_1.installAllTools(true);
                            }
        ...
        ctx.subscriptions.push(vscode.workspace.onDidChangeConfiguration((e) => goLanguageServer_1.watchLanguageServerConfiguration(e)));
        ...
        // in use.
        exports.restartLanguageServer = () => __awaiter(this, void 0, void 0, function* () {
            goLanguageServer_1.startLanguageServerWithFallback(ctx, false);
        });
        // Start the language server, or fallback to the default language providers.
        goLanguageServer_1.startLanguageServerWithFallback(ctx, true);
    ...
    ctx.subscriptions.push(vscode.commands.registerCommand('go.open.modulesdoc', () => __awaiter(this, void 0, void 0, function* () {
        vscode.commands.executeCommand('vscode.open', vscode.Uri.parse('https://github.com/golang/vscode-go/blob/master/docs/modules.md'));
    })));
    ...
    ctx.subscriptions.push(vscode.commands.registerCommand('go.locate.tools', () => __awaiter(this, void 0, void 0, function* () {
        ...
        goStatus_1.outputChannel.appendLine('GOROOT: ' + goPath_1.getCurrentGoRoot());
    ...
    ctx.subscriptions.push(vscode.commands.registerCommand('go.subtest.cursor', (args) => {
        const goConfig = util_1.getGoConfig();
        goTest_1.subTestAtCursor(goConfig, args);
    }));
    ...
    ctx.subscriptions.push(vscode.commands.registerCommand('go.tools.install', (args) => __awaiter(this, void 0, void 0, function* () {
        if (Array.isArray(args) && args.length) {
            const goVersion = yield util_1.getGoVersion();
            yield goInstallTools_1.installTools(args, goVersion);
            return;
        }
    ...
    ctx.subscriptions.push(vscode.workspace.onDidChangeConfiguration((e) => {
        ...
        if (e.affectsConfiguration('go.goroot') ||
            ...
            goInstallTools_1.updateGoVarsFromConfig();
        }
    ...
    ctx.subscriptions.push(vscode.commands.registerCommand('go.environment.choose', () => {
        goEnvironmentStatus_1.chooseGoEnvironment();
    }));
