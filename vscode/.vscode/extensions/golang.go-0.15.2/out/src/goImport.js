...
exports.addImportToWorkspace = exports.addImport = exports.getTextEditForAddImport = exports.listPackages = void 0;
...
function addImportToWorkspace() {
    ...
    if (!goRuntimePath) {
        vscode.window.showErrorMessage(`Failed to run "go list" to find the package as the "go" binary cannot be found in either GOROOT(${goPath_1.getCurrentGoRoot()}) or PATH(${goPath_1.envPath})`);
        return;
    }
