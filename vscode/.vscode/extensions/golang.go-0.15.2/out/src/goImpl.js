...
function runGoImpl(args, insertPos, editor) {
    ...
    const p = cp.execFile(goimpl, args, { env: goEnv_1.toolExecutionEnvironment(), cwd: path_1.dirname(editor.document.fileName) }, (err, stdout, stderr) => {
