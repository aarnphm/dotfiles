...
exports.RemoteSourcesAndPackages = exports.GoDebugSession = exports.Delve = exports.escapeGoModPath = void 0;
...
exports.escapeGoModPath = escapeGoModPath;
            ...
            if (launchArgs.request === 'launch') {
                ...
                if (!!launchArgs.noDebug) {
                    if (mode === 'debug') {
                        ...
                        this.debugProcess = child_process_1.spawn(goExe, runArgs, runOptions);
    ...
    close() {
        return __awaiter(this, void 0, void 0, function* () {
            const forceCleanup = () => __awaiter(this, void 0, void 0, function* () {
                ...
                yield killProcessTree(this.debugProcess);
...
class GoDebugSession extends vscode_debugadapter_1.LoggingDebugSession {
    ...
    inferLocalPathInGoRootFromRemoteGoPackage(remotePathWithLocalSeparator, relativeRemotePath) {
        ...
        const localGoRootImportPath = path.join(goroot, srcIndex >= 0
    ...
    inferLocalPathInGoPathFromRemoteGoPackage(remotePathWithLocalSeparator, relativeRemotePath) {
        ...
        const localGoPathImportPath = path.join(gopath, indexGoModCache >= 0
    ...
    stackTraceRequest(response, args) {
        ...
        this.delve.call(this.delve.isApiV1 ? 'StacktraceGoroutine' : 'Stacktrace', [stackTraceIn], (err, out) => __awaiter(this, void 0, void 0, function* () {
            if (err) {
    ...
    evaluateRequest(response, args) {
        ...
        this.evaluateRequestImpl(args).then((out) => {
            ...
            if (args.context === 'watch') {
                ...
                dest = vscode_debugadapter_1.ErrorDestination.User;
            }
    ...
    getPackageInfo(debugState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const dir = path.dirname(this.delve.remotePath.length || this.delve.isRemoteDebugging
            ...
            return new Promise((resolve) => {
                child_process_1.execFile(goPath_1.getBinPathWithPreferredGopathGoroot('go', []), ['list', '-f', '{{.Name}} {{.ImportPath}}'], { cwd: dir, env: this.delve.dlvEnv }, (err, stdout, stderr) => {
...
exports.GoDebugSession = GoDebugSession;
// Class for fetching remote sources and packages
// in the remote program using Delve.
// tslint:disable-next-line:max-classes-per-file
class RemoteSourcesAndPackages extends events_1.EventEmitter {
    constructor() {
        super(...arguments);
...
exports.RemoteSourcesAndPackages = RemoteSourcesAndPackages;
...
function queryGOROOT(cwd, env) {
    return new Promise((resolve) => {
        child_process_1.execFile(goPath_1.getBinPathWithPreferredGopathGoroot('go', []), ['env', 'GOROOT'], { cwd, env }, (err, stdout, stderr) => {
            if (err) {
                return resolve('');
            }
