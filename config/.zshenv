...
# define PATH
export PATH="/home/aarnphm/.pyenv/shims:${PATH}:$HOME/google-cloud-sdk/bin:$HOME/.poetry/bin:$GEMPATH/bin:$NPM_PACKAGES/bin:$GOPATH/bin:$GOPATH/src:$HOME/spicetify-cli/:$PYENV_ROOT/bin:$HOME/.local/bin:$HOME/.cargo/bin"
