...
-- preset keybindings.
myLauncher = "rofi -modi drun -i -p -show drun -show-icons"
...
--
myWorkspaces = ["1: term","2: web","3: focus","4: media","5: meetings"]
...
myManageHook = composeAll
    ...
    , className =? "vmware"                       --> doShift "6:vm"
    , className =? "spotify"                      --> doShift "4:media"
    , className =? "zoom"                         --> doShift "5:meetings"
    , className =? "teams"                        --> doShift "5:meetings"
    , className =? "discord"                      --> doShift "5:meetings"
    , className =? "slack"                        --> doShift "5:meetings"
...
xmobarTitleColor = "#EA6F81"

-- Color of current workspace in xmobar.
xmobarCurrentWorkspaceColor = "#313131"
...
myFont      = "xft:InconsolataGo Nerd Font:size=9:antialias=true"
